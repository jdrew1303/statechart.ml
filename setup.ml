...
(* OASIS_START *)
(* DO NOT EDIT (digest: 74f28da60076cd3dd070f97bfd4fa4a9) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Statechart_ecmascript"];
                      lib_pack = false;
                      lib_internal_modules = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("re",
                               Some (OASISVersion.VGreaterEqual "1.7.1"));
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "statechart";
                           InternalLibrary "statechart_ecmascript";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/binding/js_of_ocaml";
                   ...
                   {exec_custom = false; exec_main_is = "statechart_js.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "T-\019\000,f\221\196\179\252\187\189\223\022F\168";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
