...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9d933983d7a48727dc44d4acf0b7458c) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_statechart", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/statechart/statechart.ml";
          bugreports = None;
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Statechart"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "statechart";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "statechart_datamodel";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/datamodel";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "statechart"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules = ["Statechart_datamodel"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "statechart";
                      lib_findlib_name = Some "datamodel";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "statechart_analyzer";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/analyzer";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "statechart";
                           InternalLibrary "statechart_datamodel"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "statechart";
                      lib_findlib_name = Some "analyzer";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "statechart_datamodel_ecmascript";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/datamodel/ecmascript";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "statechart";
                           ...
                           FindlibPackage
                             ("flow_parser",
                               Some (OASISVersion.VGreaterEqual "0.38.0"))
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {
                      lib_modules = ["Statechart_datamodel_ecmascript"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "statechart_datamodel";
                      lib_findlib_name = Some "ecmascript";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "statechart_format";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules =
                        ["Statechart_format"; "Statechart_format_runtime"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "statechart";
                      lib_findlib_name = Some "format";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "statechart_interpreter";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Statechart_interpreter"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Statechart_interpreter_engine"];
                      lib_findlib_parent = Some "statechart";
                      lib_findlib_name = Some "interpreter";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "statechart_translator";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "statechart";
                           InternalLibrary "statechart_analyzer"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {
                      lib_modules = ["Statechart_translator"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "statechart";
                      lib_findlib_name = Some "translator";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "statechart_scxml";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Statechart_scxml"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "statechart";
                      lib_findlib_name = Some "scxml";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "statechart-scxml";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/scxml_cli";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "statechart_analyzer";
                           InternalLibrary "statechart_datamodel";
                           InternalLibrary "statechart_datamodel_ecmascript";
                           InternalLibrary "statechart_interpreter";
                           InternalLibrary "statechart_translator";
                           InternalLibrary "statechart_scxml";
                           FindlibPackage
                             ("cmdliner",
                   ...
                   {exec_custom = false; exec_main_is = "scxml.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "statechart_datamodel";
                           InternalLibrary "statechart_datamodel_ecmascript";
                           InternalLibrary "statechart_format";
                           InternalLibrary "statechart_interpreter";
                           InternalLibrary "statechart_translator";
                           InternalLibrary "statechart_scxml";
                           FindlibPackage
                           ...
                           FindlibPackage
                             ("crunch",
                               Some (OASISVersion.VGreaterEqual "1.4.1"))
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "test_statechart.ml"});
               Test
                 ({
                     cs_name = "test_statechart";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\247\187\160\139/\220\177\240\253\127D\227\192\177\245K";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
