...
(* OASIS_START *)
(* DO NOT EDIT (digest: 33759252bded6db033c91f66005527d9) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Statechart_analyzer"; "Statechart_analyzer_types"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "statechart_analyzer";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "statechart_format";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "statechart_interpreter";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "statechart_scxml";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "x7\177b\186\197\168U\220\253:\139\181\181)\232";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
