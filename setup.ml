...
(* OASIS_START *)
(* DO NOT EDIT (digest: 62c792f4444b6fe309b436c3d19c4f2a) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Statechart_document"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "statechart_document";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "statechart_document"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "T\\P\242\243\170\138\167\025\1842\007_\004\219\019";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
