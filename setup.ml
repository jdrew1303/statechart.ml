...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6fd99e9bc88e3d7f5fc9c0a2ce9f2124) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("core_kernel",
                               Some (OASISVersion.VGreaterEqual "113.33.0"))
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\225\0024\190\164\183\004!\156cqs\190\021Ef";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
